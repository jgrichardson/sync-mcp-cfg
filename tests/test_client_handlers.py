...
class TestClaudeCodeHandler:
    ...
    def test_save_servers(self, temp_dir, sample_servers):
        ...
        stdio_servers = [s for s in sample_servers if s.server_type == MCPServerType.STDIO]
...
class TestVSCodeHandler:
    ...
    def test_save_servers_preserves_inputs(self, temp_dir, vscode_config_data, sample_servers):
