        ...
        try:
            ...
            if ctx.obj['verbose'] and servers:
                for server in servers:
                    ...
                    console.print(f"     {enabled_icon} {server.name} ({server.server_type.value})")
...
def tui(ctx: click.Context) -> None:
    ...
    try:
        ...
        console.print("[red]TUI dependencies not installed. Install with: pip install sync-mcp-cfg[/red]")
        sys.exit(1)
    except Exception as e:
